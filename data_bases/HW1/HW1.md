...
- [Домашнее задание 1](#домашнее-задание-1)
  ...
  - [Структура проекта](#структура-проекта-наверх)
  - [Выполнение задания](#выполнение-задания-наверх)
    - [Структура базы данных](#структура-базы-данных-наверх)
    - [Нормализация базы данных](#нормализация-базы-данных-наверх)
      - [Первая нормальная форма (1НФ)](#первая-нормальная-форма-1нф-наверх)
      - [Вторая нормальная форма (2НФ)](#вторая-нормальная-форма-2нф-наверх)
      - [Третья нормальная форма (3НФ)](#третья-нормальная-форма-3нф-наверх)
      - [Итог](#итог-наверх)
...
#### Итог [наверх](https://github.com/Kontrosha/sf_data_science/blob/main/data_bases/HW1/HW1.md#содержание)
...
![customer_and_transaction_db.png](https://github.com/Kontrosha/sf_data_science/blob/main/data_bases/HW1/screenshots/customer_and_transaction_db.png)
...
- cutomers_table ![customers_table.png](https://github.com/Kontrosha/sf_data_science/blob/main/data_bases/HW1/screenshots/customers_table.png)
...
- transaction table ![transaction_table.png](https://github.com/Kontrosha/sf_data_science/blob/main/data_bases/HW1/screenshots/transaction_table.png)
